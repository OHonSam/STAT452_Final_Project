...
```{r}
ggplot(data = data_clean, aes(x = Log.GDP.per.capita)) +
  geom_histogram(binwidth = NULL, fill = "lightblue", color = "black") +
  labs(title = "Log.GDP.per.capita Distribution",
...
```{r}
ggplot(data = data_clean, aes(x = Social.support)) +
  geom_histogram(binwidth = NULL, fill = "lightblue", color = "black") +
  labs(title = "Social Support Distribution",
       x = "Social support",
       y = "Frequency") +
  theme_minimal() + 
  theme(
